...
const HeaderComponent = ({ isHiddenSearch = false, isHiddenCart = false }) => {
  ...
  return (
    <div style={{  heiht: '100%', width: '100%', display: 'flex',background: '#030303', justifyContent: 'center' }}>
      <WrapperHeader style={{ justifyContent: isHiddenSearch && isHiddenSearch ? 'space-between' : 'unset' }}>
        <Col span={5}>
          <WrapperTextHeader to='/'>COMPUTER SHOP</WrapperTextHeader>
        </Col>
        {!isHiddenSearch && (
          <Col span={13}>
            <ButttonInputSearch
